...
public class ButtonStar extends Actor{
    private float rad;

    private Texture circle;

    public ButtonStar(GameScreen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    }
    public ButtonStar(Lvl1Screen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    }
    public ButtonStar(Lvl2Screen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    }
    public ButtonStar(FinalBossScreen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    }
    public ButtonStar(Lvl3Boss1Screen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    }
    public ButtonStar(Lvl3Boss2Screen screen, Texture circle, Player player) {
        this.circle = circle;
        setDefaultWH();
        setDefaultXY();
        addListener( new ButtonStarListener(screen, player));
    ...
    public void setDefaultXY(){
        setX(GameScreen.SCR_WIDTH - GameScreen.SCR_WIDTH/6f - GameScreen.SCR_WIDTH/13f - GameScreen.SCR_WIDTH/10f);
