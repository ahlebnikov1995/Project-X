...
public class Button4 extends Actor {
    ...
    public Button4(Texture imgBut, Texture imgBut2) {
        this.imgBut = imgBut;
        this.imgBut2 = imgBut2;
        this.curTexture = imgBut;
        setDefaultWH();
        setDefaultXY();
        addListener(new Button4Listener(imgBut,imgBut2,this));
    }
    ...
    public void setDefaultXY(){
        setX(GameScreen.SCR_WIDTH/8f + GameScreen.SCR_WIDTH/6f);
        setY(GameScreen.SCR_HEIGHT - GameScreen.SCR_HEIGHT/3f - this.getHeight());
    }
