...
public class Boss2 extends Enemy {
    ...
    public Boss2(Array<MyTree> trees, Player player, Animation animAttack, Animation animAttack2, Animation animMove, Animation animMove2, Animation animShoot, Animation animShoot2) {
        super(5000,
    ...
    public Boss2(Player player, Animation animAttack, Animation animAttack2, Animation animMove, Animation animMove2, Animation animShoot, Animation animShoot2) {
        super(7500,
                GameScreen.SCR_WIDTH / 10f,
                GameScreen.SCR_WIDTH / 10f);
        this.player = player;
            ...
            if (trees.get(i).overlaps(this)) {
                ...
                if (this.getX() > trees.get(i).getX() && trees.get(i).getX() > this.getX() - trees.get(i).getWidth() - trees.get(i).getWidth() / 2f && trees.get(i).getX() < this.getX() - trees.get(i).getWidth()) {
                    ...
                    if (this.getX() < trees.get(i).getX() && trees.get(i).getX() > this.getX() + this.getWidth() / 2f && trees.get(i).getX() < this.getX() + this.getWidth() / 2f + trees.get(i).getWidth() / 2f) {
                        ...
                        if (this.getY() > trees.get(i).getY() && player.getY() < this.getY())
                            this.setVy(grassVY);
                        if (this.getY() < trees.get(i).getY() && player.getY() > this.getY())
                            this.setVy(grassVY);
